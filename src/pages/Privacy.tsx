    ...
    <LegalPageLayout title="Privacy Policy." lastUpdated="April, 2026">
      ...
      <ul>
        ...
        <li>
          ...
          "Us" or "Our" in this Privacy Policy) refers to Devansh's Portfolio.
        </li>
        <li>
        ...
        <li>
          ...
          We use "Personal Data" and "Personal Information" interchangeably
        ...
        <li>
          <strong>Website</strong> refers to Devansh's Portfolio, accessible from{" "}
          <a
            href="https://devansh-studio.vercel.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            https://devansh-studio.vercel.app/
          </a>
          .
        </li>
        <li>
      ...
      <p>
        ...
        type of mobile device You use, Your mobile device's unique ID, the IP
      ...
      <p>
        ...
        needed for the relevant purpose. We apply different retention periods to
        different categories of Personal Data based on the purpose of processing
      ...
      <ul>
        <li>
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            https://devansh-studio.vercel.app/#contact
          </a>
        </li>
      </ul>
    </LegalPageLayout>
